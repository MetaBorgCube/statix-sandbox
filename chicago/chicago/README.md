# chicago Language Specification
...
such that all files are analyzed together, and files can refer to each other --/Users/eelcovisser/03-Research/MetaBorgCube/statix-sandbox/chicago/chicago/README.md
multi-file analysis.
